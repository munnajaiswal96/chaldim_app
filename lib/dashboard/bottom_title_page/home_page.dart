...
//   }
//
// //to fetch explore data from firebase realtime database
...
//                         return ListTile(
//                           title: Text(snapshot.child('title').toString()),
//                         );
//                       },
//                   ),
//                 ],
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        onTap: () {},
                        child: Container(
                          margin: EdgeInsets.only(right: 15, top: 10, bottom: 10, left: 10),
                          width: 250,
                          height: 300,
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(12),
            ...
            //               context, images.values.elementAt(index));
            //         },
            //         child: Container(
            //           margin:
